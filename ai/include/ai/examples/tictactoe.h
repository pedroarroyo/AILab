...
//	private:
	...
	struct TicTacToePolicy : public Game_t<TicTacToeTreeNode, TicTacToeMove, TicTacToePlayer>
	{
		...
		virtual std::vector<TicTacToeMove> LegalMoves(const TicTacToeTreeNode& node, const TicTacToePlayer& player) const override 
		{
		...
		virtual TicTacToeTreeNode MakeMove(const TicTacToeMove& Move_t, const TicTacToeTreeNode& node) const override 
		{
